...
int main (void){
  ...
  moyenne=moyenne;
  if (moyenne >0 || moyenne <=6) printf(" c 'est pas assez !besoin beaucoup d'effort\n");
  else if (moyenne >6 || moyenne <10) {printf( " encore un peu !\n");}
  else if (moyenne >=10 || moyenne <12) {printf(" felicitation ! vous êtes admis avec mention passable \n");}
  else if (moyenne >=12 || moyenne <14) {printf(" felicitation ! vous êtes admis avec mention assez bien \n");}
  else if (moyenne >=14 || moyenne <16) {printf(" felicitation ! vous êtes admis avec mention bien \n");}
  else if (moyenne >=16 || moyenne <18) {printf(" felicitation ! vous êtes admis avec mention très bien \n");}
  else if (moyenne >=18 || moyenne <20) {printf(" felicitation ! vous êtes admis avec mention honorable \n");}
  return (0);
  }
